...
library = [
    ...
    {"title": "The Diary of a Young Girl", "author": "Anne Frank", "year": "1947",
     "total_copies": 2, "available_copies": 2, "issued": []},

    {"title": "Think Like a Monk", "author": "Jay Shetty", "year": "2020",
     "total_copies": 5, "available_copies": 5, "issued": []},

    {"title": "Bhagavad Gita", "author": "Vyasa", "year": "Ancient",
     "total_copies": 6, "available_copies": 6, "issued": []},

     {"title": "Unfinished", "author": "Priyanka Chopra Jonas", "year": "2021",
     "total_copies": 3, "available_copies": 3, "issued": []},

    {"title": "Wings of Fire", "author": "A.P.J. Abdul Kalam", "year": "1999",
     "total_copies": 6, "available_copies": 6, "issued": []},

    {"title": "It Ends With Us", "author": "Colleen Hoover", "year": "2016",
     "total_copies": 4, "available_copies": 4, "issued": []},

    {"title": "Do Epic Shit", "author": "Ankur Warikoo", "year": "2021",
     "total_copies": 5, "available_copies": 5, "issued": []},
    ...
    if library:
        try:
            ...
            if 1 <= choice <= len(library):
                ...
                print("\n--- Leave blank if you do not want to change the field ---")
